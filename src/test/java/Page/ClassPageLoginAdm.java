...
public class ClassPageLoginAdm extends ClassBase {
    ...
    public ClassPageLoginAdm(WebDriver driver) {
        super(driver);
    }
    public void loginUser() throws InterruptedException {
        ...
        if(isDisplayed(BtnLogSnt)){
            do{
                type(ClassUtils.ZeeUsrAdm,TxtUsrZee);
                type(ClassUtils.ZeePasAdm,TxtPasZee);
                click(BtnLogZee);
                Thread.sleep(2000);
