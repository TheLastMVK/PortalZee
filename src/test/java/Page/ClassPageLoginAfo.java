...
public class ClassPageLoginAfo extends ClassBase {
    ...
    public ClassPageLoginAfo(WebDriver driver) {
        super(driver);
    }
    public void loginUser() throws InterruptedException {
        ...
        if(isDisplayed(BtnLogSnt)){
            do{
                type(ClassUtils.ZeeUsrAfo,TxtUsrZee);
                type(ClassUtils.ZeePasAfo,TxtPasZee);
                click(BtnLogZee);
                Thread.sleep(2000);
