...
public class ClassPageLoginUser extends ClassBase{
    ...
    public ClassPageLoginUser(WebDriver driver) {
        super(driver);
    }
    public void loginUser() throws InterruptedException {
        ...
        if(isDisplayed(BtnLogSnt)){
            do{
            type(ClassUtils.ZeeUsrUsr,TxtUsrZee);
            type(ClassUtils.ZeePasUsr,TxtPasZee);
            click(BtnLogZee);
            Thread.sleep(2000);
